            ...
            <div class="col-md-9">
                <div class="panel panel-white">
                    <div class="panel-heading clearfix">
                        <h4 class="panel-title">New Basket Form</h4>
                    </div>
                    <div class="panel-body">
                        <form method="POST" action="{{ route('dashboard.basket.store') }}" class="form-horizontal">
                            @csrf
                            ...
                            <div class="form-group @error('sort_rank') has-error  @enderror">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="sort_rank" name="sort_rank" value="{{ old('sort_rank') }}">
                                    @error('sort_rank')
                                        <p class="help-block" style="margin-bottom:0;">{{ $message }}</p>
                                    @enderror
                                </div>
